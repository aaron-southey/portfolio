...
function App() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* Footer */}
      <footer className="w-full bg-gradient-to-t from-muted/80 to-background/90 text-muted-foreground border-t border-border shadow-inner mt-auto">
        <div className="container mx-auto px-4 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex flex-col md:flex-row items-center gap-2 md:gap-4 text-center md:text-left">
            <span className="font-semibold text-primary">&copy; {new Date().getFullYear()} Aaron Southey</span>
            <span className="hidden md:inline">|</span>
            <span className="text-xs md:text-sm">Quality Engineer Portfolio</span>
          </div>
